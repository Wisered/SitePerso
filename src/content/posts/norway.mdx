...
No projects in this course, just exams.
...
Since we had a big project all semester long to check our knowledge on the subject, we covered many skills such as:
...
- The first part was kind of special since we had the whole semester to complete it (one month for the other). We had access to "SecureCodeWarrior", a software security website, with exercices about how to write safe code. This part was done solo. (**Grade**: 20/20)
- In the second part, we (as a group) had to PenTest (penetration testing) a web application and write a report on the vulnerabilities we found (both black and white box). (**Grade**: 30/30)
- The third part naturally followed the second since we had to fix a list of vulnerabilities. We had access to our group web application github on which we could implement solutions and check wether they worked or not and then push it on production website. We also wrote a report at the end, to show and explain how we corrected the initial code to make it secure. (**Grade**: 30/30)
- Finally, the fourth part was about Threat modeling & risk management framework. We had a business description and needed to find assets (both business and technical) and threats to these assets, how to protect them and imagine attackers scenarios. We wrote all of this in a report.(**Grade**: 20/20)<br /><br />
