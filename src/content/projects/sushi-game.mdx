...
<img src="/SushiGame/Screenshot-0.png" className="max-w-m" />
<img src="/SushiGame/Screenshot-2.png" className="max-w-m" />  
<img src="/SushiGame/Screenshot-3.png" className="max-w-m" />  
<img src="/SushiGame/Screenshot-4.png" className="max-w-m" />  
<img src="/SushiGame/Screenshot-5.png" className="max-w-m" />  
<img src="/SushiGame/Screenshot-6.png" className="max-w-m" />  
